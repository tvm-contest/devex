...
function peg$parse(input, options) {
                  ...
                  if (s4 !== peg$FAILED) {
                    ...
                    if (s5 !== peg$FAILED) {
                      ...
                      if (s6 !== peg$FAILED) {
                        s7 = peg$parse__();
                        if (s7 !== peg$FAILED) {
                          s8 = peg$parseVariableDeclarationList();
                          if (s8 !== peg$FAILED) {
                            s9 = peg$parse__();
                            if (s9 !== peg$FAILED) {
                              if (input.charCodeAt(peg$currPos) === 58) {
                              ...
                              if (s10 !== peg$FAILED) {
                                s11 = peg$parse__();
                                if (s11 !== peg$FAILED) {
                                  s12 = peg$parseVariableDeclarationList();
                                  if (s12 !== peg$FAILED) {
                                    s13 = peg$parse__();
                                    if (s13 !== peg$FAILED) {
                                      if (input.charCodeAt(peg$currPos) === 41) {
  ...
  function peg$parseOnCodeUpgradeDeclaration() {
    ...
    s0 = peg$currPos;
    s1 = peg$parseOnCodeUpgradeToken();
    if (s1 !== peg$FAILED) {
      s2 = peg$parse__();
      if (s2 !== peg$FAILED) {
        s3 = peg$parseFunctionName();
  ...
  function peg$parseAfterSignatureCheckDeclaration() {
    ...
    s0 = peg$currPos;
    s1 = peg$parseAfterSignatureCheckToken();
    if (s1 !== peg$FAILED) {
      s2 = peg$parse__();
      if (s2 !== peg$FAILED) {
        s3 = peg$parseFunctionName();
