...
library UserInfo 
{
    ...
    function getAccount   (uint32 answerId) public pure {    IUserInfo(addr).getAccount   (answerId);    }
    function getPublicKey (uint32 answerId) public pure {    IUserInfo(addr).getPublicKey (answerId);    }
    function getSigningBox(uint32 answerId) public pure {    IUserInfo(addr).getSigningBox(answerId);    }
}
