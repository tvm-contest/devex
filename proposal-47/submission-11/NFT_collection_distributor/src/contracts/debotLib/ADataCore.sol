...
abstract contract DataCore is IDataCore, IndexResolver {
    ...
    function isTrusted(address addrTrusted) inline private view returns (bool) {
        return _addrTrusted == addrTrusted;
    }

    function isManager(address addrManager) inline private view returns (bool) {
