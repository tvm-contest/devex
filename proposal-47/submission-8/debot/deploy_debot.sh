...
pubkey=0xfa7e1881214cf95618099e1fc5487755275dbf5569890f004e646ab7f25f2a5c
nft=0:98b2d789b638b815431cc96c939f7dd998b3a4d816aa7bd8685add6c71930813
./tonos-cli --url $NETWORK call $DEBOT_ADDRESS setNFTCollection "{\"root\":\"$nft\",\"pubkey\":\"$pubkey\"}" --sign $DEBOT_NAME.keys.json --abi $DEBOT_NAME.abi.json
