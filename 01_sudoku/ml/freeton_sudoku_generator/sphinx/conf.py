...
# -*- coding: utf-8 -*-
#
# sudoku_generator documentation build configuration file, created by
# sphinx-quickstart.
#
...
copyright = 'TS <ts@noemailsplease.com>'
author = 'TS <ts@noemailsplease.com>'
...
latex_documents = [
    (master_doc, 'sudoku_generator.tex', 'sudoku_generator Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'sudoku_generator', 'sudoku_generator Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'sudoku_generator', 'sudoku_generator Documentation',
     author, 'sudoku_generator', 'One line description of project.',
     'Miscellaneous'),
]
