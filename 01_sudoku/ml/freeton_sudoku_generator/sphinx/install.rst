...
If :code:`sudoku_generator` is available in your opam repository, you can just call::

  opam install sudoku_generator

Build and install with :code:`dune`
-----------------------------------

Checkout the sources of :code:`sudoku_generator` in a directory.
