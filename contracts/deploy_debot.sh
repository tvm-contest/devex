...
tonos-cli --url $NETWORK deploy $DEBOT_NAME.tvc "{\"_root\":\"0:930f9f56ae2bc14e6dc915f017c0cd8c7d94c288bfac7ba1a3061cb28a424b01\"}" --sign $DEBOT_NAME.keys.json --abi $DEBOT_NAME.abi.json
