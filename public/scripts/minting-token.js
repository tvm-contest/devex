...
for(var keyID in obj.collection.rarities){
    if(obj.collection.rarities != []){
        //console.log(obj.collection.rarities[keyID].name)
...
for(var keyID in obj.collection.parameters){
    if(obj.collection.parameters != []){
        ...
        //console.log(obj.collection.parameters[keyID].name)
        ...
        $(`#parameters${keyID}`).append($(`<input class="form-control name="paramener[${keyID}]">`))   
        }
    }
}
