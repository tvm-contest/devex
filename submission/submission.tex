...
\begin{description}
	...
	\item[Keys on contracts: ] In the Euler and Pincode smart
          ...
          proving key for the Sudoku has size 64KB (19KB after
          compression) which is about 6 times (respectively 10 times
          once zipped) bigger than for Euler and Pincode, and we
