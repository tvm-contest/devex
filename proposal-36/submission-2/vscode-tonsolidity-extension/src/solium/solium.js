...
const solidityParser = new Parser();
const solExplore = require("../parser/explorer"),
...
module.exports = (function() {
    ...
    Solium.lint = function lint(sourceCode, config, noReset) {
        ...
        try {
            ...
            AST = solidityParser.parse(sourceCode, "tonsolidity", false, { comment: true });
        } catch (e) {
